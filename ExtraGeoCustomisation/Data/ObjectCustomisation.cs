...
{
    [System.Serializable]
    public class ObjectCustomisation
    {
        public bool CreateNewObject { get; set; } = false;
        public Vector3 Position { get; set; }
        public eCustomisationType CustomisationType { get; set; } = eCustomisationType.none;

        public CustomTextObject customText {  get; set; }
